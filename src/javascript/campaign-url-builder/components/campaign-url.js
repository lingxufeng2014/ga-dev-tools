    ...
    renderBitlyNotice() {
      ...
      return this.state.showBitlyNotice ?
        <div className="CampaignUrlResult-bitlyNotice">
          ...
          deprecation</a> of <a href="https://goo.gl/">Google's url shortener
          ...
          can create shortlinks on your behalf. See the <a
          href="https://github.com/googleanalytics/ga-dev-tools/issues/377">
          Github tracking issue</a> for more details.</span>
        </div>
      : null;
  }
